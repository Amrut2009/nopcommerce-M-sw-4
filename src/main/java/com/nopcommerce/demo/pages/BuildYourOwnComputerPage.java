...
public class BuildYourOwnComputerPage extends Utility {
    ...
    public void setProcessorFieldDropDown(String option){
        selectByVisibleTextFromDropDown(processorFieldDropDown,option);
    }
    public void RAMFieldDropDown(String option){
        selectByVisibleTextFromDropDown(RAMFieldDropDown,option);
    }
    public void HDDRadioButton(String option){
    ...
    public void selectProcessorFieldDropDownOption(String s) {
        selectByVisibleTextFromDropDown(processorFieldDropDown,s);
    }

    public void selectRAMFieldDropDownOption(String s) {
        selectByVisibleTextFromDropDown(RAMFieldDropDown,s);
    }
